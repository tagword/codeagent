"""
Token 计数适配层 — 基于 seed.core.token_counter，增加 attachment tag 剥离。

如需使用原始 DeepSeek tokenizer 计数，直接 from seed.core.token_counter import count_tokens.
"""
...
from seed.core.token_counter import count_tokens  # noqa: F401 — re-export
...
def count_messages(messages: list[dict[str, Any]]) -> dict[str, int]:
    ...
    from seed.core.token_counter import count_tokens as _cnt_tok
