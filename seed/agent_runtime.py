...
from seed.llm_exec import LLMAPIExecutor
...
def default_system_prompt() -> str:
    ...
    try:
        from seed.config_plane import build_system_prompt

        base = build_system_prompt()
        # Multi-agent core memory (persona/memory.md) — best-effort append.
        try:
            from codeagent.core.paths import agent_id_default, agent_persona_memory_path
...
from seed.chat_events import emit_chat_event
from seed.llm_exec import LLMAPIExecutor, LLMError
...
from seed.chat_events import emit_chat_event
from seed.llm_exec import LLMAPIExecutor
from seed.tools import ToolExecutor, ToolRegistry
