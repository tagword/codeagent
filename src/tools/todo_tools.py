...
def todo_tool_handler(
    ...
    try:
        from src.proj_todos_pkg import list_todos, create_todo, update_todo, delete_todo
        from src.agent_context import active_episodic_project_id, get_active_llm_session
