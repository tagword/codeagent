...
from src.tools import ToolRegistry, setup_builtin_tools
from src.persistence import ensure_session_dir, list_sessions, save_session
from src.routing import find_commands, get_all_commands, get_command
...
from src.routing import find_commands
...
def _cmd_chat_llm(args):
    ...
    from src.config_plane_pkg import project_root as _project_root
...
from src.persistence import list_sessions, save_session


def cmd_serve(args):
    try:
        from src.server_pkg import main as server_main
...
def cmd_config(args):
    from src.config_plane_pkg import ensure_default_config_files, project_root
...
def cmd_session(args):
    ...
    if action == 'list':
        ...
        from src.persistence import delete_session
