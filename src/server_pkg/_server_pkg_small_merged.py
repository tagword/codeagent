...
def main(host: str = "0.0.0.0", port: int = 8765) -> None:
    ...
    from src.server_pkg.create_app_p1_s1 import create_app
...
def _webui_root() -> Path:
    # server_pkg/../../ -> project root (webui.html and webui/ live here)
...
def get_setup_html() -> str:
    ...
    parts_dir = root / "src" / "setup_parts"
    names = (
        "setup_head.html",
        "setup_form.html",
        "setup_test.html",
    ...
    return (
        ...
        "<p>缺少向导片段（<code>src/setup_parts/*.html</code>）。"
