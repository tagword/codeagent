...
def _project_fs_dir(agent_id: str, project_id: str) -> Optional[Path]:
    from src.proj_reg_pkg import get_project
...
def _locate_session_file(
    ...
    from src.llm_sess_pkg import _find_session_file
...
def _transcript_json_for_session(
    ...
    from src.server_pkg._server_pkg_small_merged import (
...
def build_webui_api_app(project_root: Path) -> Starlette:
    ...
    from src.config_plane_pkg import CONFIG_FILENAMES, ensure_default_config_files
    from src.config_plane_pkg import project_root as project_root_fn
    from src.cron_sched_pkg import (
        cron_status_for_ui,
        delete_cron_job,
        load_cron_config,
    ...
    from src.env_config import ENV_FILENAME
    ...
    from src.llm_sess_pkg import load_chat_session_from_disk
    from src.proj_reg_pkg import (
        create_project,
        delete_project,
    ...
    from src.proj_todos_pkg import delete_todo, list_todos, update_todo
    from src.server_pkg import SESSIONS
    from src.server_pkg._server_pkg_small_merged import _memkey
    from src.ui_settings import plugins_public_view, save_plugins_from_ui
    from src.webui_auth import COOKIE_NAME, get_webui_token, make_webui_cookie_value
    ...
    async def api_auth_status(request: Request) -> JSONResponse:
        from src.webui_auth import verify_webui_cookie
    ...
    async def api_auth_login(request: Request) -> JSONResponse:
        ...
        from src.webui_auth import ws_query_token_bridge_enabled
    ...
    async def api_config_paths(_: Request) -> JSONResponse:
        ...
        try:
            from src.codeagent.core.paths import agent_persona_dir, agent_skills_dir
    ...
    async def api_projects_create(request: Request) -> JSONResponse:
        ...
        row: Dict[str, Any] = {}
        try:
            from src.codeagent.core.paths import agent_projects_data_dir, ensure_agent_scaffold
    ...
    async def api_projects_plans(request: Request) -> JSONResponse:
        ...
        try:
            from src.proj_reg_pkg.delete_project import get_project_data_subdir
    ...
    async def api_setup_finish(_: Request) -> JSONResponse:
        ...
        cfg = project_root / "config"
        cfg.mkdir(parents=True, exist_ok=True)
        from src.webui_auth import TOKEN_FILENAME
