...
from seed_engine.commands import CommandRouter
from seed_engine.llm_exec import LLMAPIExecutor
from seed_engine.mem_sys import MemorySystem
from seed_engine.models import Session, TurnResult, UsageSummary
from seed_tools import ToolExecutor, ToolRegistry
...
class TurnLoopEngine:
    ...
    def _save_session_if_enabled(self) -> None:
        ...
        if self.config.auto_save:
            ...
            from seed.sess_store import SessionManager
